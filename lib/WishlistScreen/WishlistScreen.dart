        ...
        child: FutureBuilder(
          ...
          builder: (context, AsyncSnapshot<List<Wishlist>> snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              List<Wishlist> wishlists = snapshot.data!.toList();
                            ...
                            Navigator.push<void>(
                              ...
                              MaterialPageRoute<void>(
                                builder: (BuildContext context) => HotelDetails(
                                  ...
                                  room_no: wishlist.room_no.toString(),
                                  hotellocation: wishlist.hotelLocation,
                                  hotelavgrating: wishlist.avgRating.toString(),
                                  hotelemail: wishlist.email,
                                  hotelprice: wishlist.price.toString(),
                                  startDate: DateTime.now(),
                                  endDate: DateTime.now().add(Duration(days: 1)),
                                  description: wishlist.description,
                                  possible_no_of_guests: wishlist.possible_no_of_guests.toString(),
                                ),
                              ),
                            );
                          },
                              ...
                              ClipRRect(
                                child: Container(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(5),
                                    child: Image.network(
                                      'https://hotel-app-1-v54y.onrender.com/uploads/${wishlist.roomPhoto.replaceAll(RegExp(r'\[|\]|"'), '')}',
                                      width: double.infinity,
                                      height: 250.0,
                                      fit: BoxFit.cover,
                                    ),
