...
class _HotelDetailsState extends State<HotelDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    if(checkinDay!=null){
      start_day = checkinDay;
    }else    start_day = widget.startDate.day;
  
    if(checkinMonth!=null){
      start_month = checkinMonth;
    }else    start_month = widget.startDate.month;
  
    if(checkinYear!=null){
      start_year = checkinYear;
    }else    start_year = widget.startDate.year;
  
    if(checkoutDay!=null){
      end_day = checkoutDay;
    }else    end_day = widget.endDate.day;
  
    if(checkoutMonth!=null){
      end_month = checkoutMonth;
    }else    end_month = widget.endDate.month;
  
    if(checkoutYear!=null){
      end_year = checkoutYear;
    }else    end_year = widget.endDate.year;
    ...
    double totalPrice = double.parse(widget.hotelprice) * difference.inDays;
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Center(
                                                    child: DropdownButton<int>(
                                                      hint: Text(
                                                        '${checkinDay != null ? checkinDay : widget.startDate.day}',
                                              ...
                                              child: ClipRRect(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Center(
                                                    child: DropdownButton<int>(
                                                      hint: Text(
                                                        '${checkinMonth != null ? checkinMonth : widget.startDate.month}',
                                                        style: TextStyle(color: Colors.white, fontSize: 14),
                                                      ),
                                                      iconEnabledColor: Colors.white,
                                                      dropdownColor: Color(0xFFFF5757),
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Center(
                                                    child: Container(
                                                      child: DropdownButton<int>(
                                                        hint: Text(
                                                          '${checkinYear != null ? checkinYear : widget.startDate.year}',
                                                          style: TextStyle(color: Colors.white, fontSize: 14),
                                                        ),
                                                        iconEnabledColor: Colors.white,
                                                        dropdownColor: Color(0xFFFF5757),
                                              ...
                                              child: ClipRRect(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Center(
                                                    child: DropdownButton<int>(
                                                      hint: Text(
                                                        '${checkoutDay != null ? checkoutDay : widget.endDate.day}',
                                                        style: TextStyle(color: Colors.white, fontSize: 14),
                                                      ),
                                                      iconEnabledColor: Colors.white,
                                                      dropdownColor: Color(0xFFFF5757),
                                              ...
                                              child: ClipRRect(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Center(
                                                    child: DropdownButton<int>(
                                                      hint: Text(
                                                        '${checkoutMonth != null ? checkoutMonth : widget.endDate.month}',
                                                        style: TextStyle(color: Colors.white, fontSize: 14),
                                                      ),
                                                      iconEnabledColor: Colors.white,
                                                      dropdownColor: Color(0xFFFF5757),
                                              ...
                                              child: ClipRRect(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Center(
                                                    child: DropdownButton<int>(
                                                      hint: Text(
                                                        '${checkoutYear != null ? checkoutYear : widget.endDate.year}',
                                                        style: TextStyle(color: Colors.white, fontSize: 14),
                                                      ),
                                                      iconEnabledColor: Colors.white,
                                                      dropdownColor: Color(0xFFFF5757),
                                      ...
                                      Text.rich(
                                        TextSpan(
                                          children: [
                                            TextSpan(
                                              text: '\$${totalPrice}',
                                              style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF000000)), // Bold and larger font size for totalPrice
                                            ),
                                            TextSpan(
                                              text: ' for ${difference.inDays} days',
                                              style: TextStyle(fontSize: 14, color: Color(0xFF000000)), // Base style
                                            ),
                                          ],
                                        ),
                                      ),
